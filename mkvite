...
if ((PARAMS === 0) || (NAME.includes("--help"))) {
  console.log(`${color("green", "mkvite")} ${VERSION} - Por Samurai.dev.ord ( ${color("magenta", "https://samurai.dev.ord/")} )\n`);
  console.log(`Sintaxis:`);
  console.log(`mkvite <nombre-carpeta> [options]\tCrea un proyecto web.\n`);
  console.log(`Ejemplos:`);
  console.log(`mkvite sample-project -> ${color("magenta","Crea un proyecto HTML/CSS/Javascript nativo")}.`);
...
if (NAME && NAME.indexOf("--") === 0) {
  console.log(`Sintaxis:`);
  console.log(`mkvite <nombre-carpeta> [options] -> ${color("magenta","Crea un proyecto web.\n")}`);
...
exec("rm main.js style.css counter.js javascript.svg public/vite.svg index.html");
...
<head>
  ...
  <title>${NAME} - Víctor Manuel Ordiales Garcia</title>
  <link rel="stylesheet" href="./index.css">
  <script type="module" src="./index.js"></script>
</head>
<body>
  <h1 style="text-align:center;">${NAME} - Víctor Manuel Ordiales Garcia</h1>
</body>
</html>
EOF`);
